...
//        get() {
//            return history.nodes.last().completed
//        }
//    val currentTick: Int
//        get() {
//            return history.nodes.last().tick
//        }
//
//    val history: TrajectoryHistory = TrajectoryHistory()
//
//    val position: Vec3
//        get() {
//            return history.nodes.last().position
//        }
//    val velocity: Vec3
//        get() {
//            return history.nodes.last().velocity
//        }
//
//    init {
...
//        initialized = true
//        this.history.pushNode(TickNode(0, position, velocity))
//    }
//
...
//        }
//        if (this.completed) {
//            return this.history.lastNode()
//        }
//
//        val lastNode = this.history.lastNode().processTick(level)
//        this.history.pushNode(lastNode)
//
...
//        val clientNode = this.history.find { it.tick ==msg.tick }
//        if (clientNode == null) {
...
//    val nodes: TrajectoryNodeCache = TrajectoryNodeCache()
//
//    fun pushNode(node: TickNode){
//        this.nodes.add(node)
//        this.positions.add(node.position)
//    }
//
//    fun lastNode(): TickNode{
//        return this.nodes.last()
//    }
//}
//
//
//class TrajectoryNodeCache(private val internal: MutableList<TickNode> = mutableListOf()
//): MutableList<TickNode> by internal {
//    companion object{
//        const val MAX_CACHE_SIZE = 5
//    }
//
//    override fun add(element: TickNode): Boolean {
...
//    }
//
//    override fun addAll(elements: Collection<TickNode>): Boolean {
